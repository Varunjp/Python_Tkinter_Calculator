...
# text_area = Label(Window,bg="#b4c2a9",width="50",height="4")
# text_area.grid(row=0,column=0, padx=20)
...
buttondot.grid(row=3, column=0, padx=10, pady=10)
...
button_div.grid(row=0, column=3, padx=10, pady=10)

button_mul= Button(Window, text="x", width=10, height=2)
button_mul.grid(row=1, column=3, padx=10, pady=10)
...
button_add.grid(row=3, column=3, padx=10, pady=10)
